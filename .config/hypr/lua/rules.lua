...
-- pypr dropdown files (keep in sync with pyprland.toml scratchpads + binds)
hl.window_rule({ match = { class = [[^(pypr-files)$]] }, float = true })
hl.window_rule({ match = { class = [[^(pypr-files)$]] }, center = true })
hl.window_rule({ match = { class = [[^(pypr-files)$]] }, size = { "60%", "70%" } })
